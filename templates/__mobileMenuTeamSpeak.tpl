...
<li class="menuOverlayItem" data-more="eu.hanashi.wsc.teamspeak-viewer">
    <a href="{link controller='TeamSpeakViewer'}{/link}" class="menuOverlayItemLink menuOverlayItemBadge box24" data-badge-identifier="teamspeakUsers">
        <span class="icon icon24 teamspeak-icon">
        ...
        <span class="menuOverlayItemTitle">{lang}wcf.page.teamSpeakViewer.title{/lang}</span>
